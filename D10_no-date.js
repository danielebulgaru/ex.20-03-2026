...
console.log(splitMe("Ciao mi chiamo Daniele"))

/* ESERCIZIO 4
  Crea una funzione chiamata "deleteOne" che riceve una stringa e un booleano come parametri.
  Se il valore booleano è true la funzione deve ritornare la stringa senza il primo carattere, altrimenti la deve ritornare senza l'ultimo.
*/
const deleteOne = function (str, flag) {
  if (flag === true) {
    return str.slice(1)
  } else {
...
console.log(deleteOne("Daniele", true))
console.log(deleteOne("Daniele", false))
...
console.log(onlyLetters("Ho comprato 32 mele"))
...
console.log(isThisAnEmail("marco.rossi@gmail.com"))
console.log(isThisAnEmail("marcoRossiGmail.com"))
...
console.log(deleteProp({ name: "Daniele", age: 19 }, "age"))
...
const sumAllTheYears = function (movies) {
  ...
  for (let i = 0; i < movies.length; i++) {
    sum1 = sum1 + Number(movies[i].Year)
  }
...
/*Esercizio 17*/
const searchByTitle = function (text, movies) {
  let result = []

  for (let i = 0; i < movies.length; i++) {
    if (movies[i].Title.includes(text)) {
...
/* Esercizio 18*/
const searchAndDivide = function (text, movies) {
  let match = []
  let unmatch = []
